...
export const announcements: Announcement[] = [
  {
    ...
    details: [
      "修复建房、比赛结果与私聊弹窗的焦点越界和关闭焦点丢失，阻止弹窗后误操作对局",
      "不限时建房自动停用读秒，围棋引擎拒绝小数、无穷与非数交叉点，避免非法盘面进入棋谱",
      "已结束棋局统一进入棋谱回放，并限制外部棋手查询长度，消除固定高度窗口内容溢出",
      "修复关闭 BGM 时的首音漏播和零音量保存后的残留成功音，复验 SFX、BGM 与 Pages 静态路由",
    ],
  },
...
export const historicalAnnouncements: Announcement[] = [
  {
    type: "公告",
    text: "围达网 1.0.0 正式版上线",
    date: "2026-08-16",
    version: "1.0.0",
    details: [
      "完成围达网静态正式版：保留 2001 年高密度旧式窗口、模糊画质与硬边框交互",
      "修复设置草稿被画质或 BGM 切换覆盖，完善建房规则、贴目联动与关闭焦点恢复",
      "修复比赛结果与私聊窗口叠加，补回终局结果入口并统一棋谱棋手搜索行为",
      "复验中日规则、气与提子、禁自杀、简单劫、棋钟、终局、SGF、SFX/BGM 和 Pages 构建",
    ],
  },
  {
    type: "公告",
    text: "围达网 0.8.1 规则回归修复版上线",
    date: "2026-08-12",
    version: "0.8.1",
    details: [
